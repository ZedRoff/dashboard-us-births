...
def show() -> html.Div:
    ...
    return html.Div(
        [
            ...
            html.H1('''The page presents a set of Global statistics showcasing
                    key data points related to births and maternal age across 
                    different states.''', className="desc"),
            html.Div(
                [
                    html.Div(
                        [
