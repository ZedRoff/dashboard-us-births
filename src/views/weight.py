...
def show() -> html.Div :
    ...
    return html.Div([
        html.H2("Graphics about weight", className="graph_part_title"),
          html.H1('''This page presents a histogram displaying the distribution
                  of average birth weights by gender 
                  (girls in red, boys in blue).''', className="desc"),
        html.Div([
                ...
                html.Div([
                    ...
                    html.P('''The histogram, divided into red bars (girls) and blue bars (boys),
                           shows the distribution of average birth weights, ranging from 2600 g 
                           to 3600 g, with a concentration between 3200 g and 3400 g. Boys tend 
                           to dominate the higher weight ranges, especially between 3400 g and
                           3600 g, while girls are more common in the 3000 g to 3400 g range.
                           The highest total weighted birth weight is centered around 3200 g 
                           to 3300 g, with girls having slightly higher weights in this range.
                           Overall, most births have an average weight between 3100 g and 3400
                           g, with boys being slightly heavier in the higher weight ranges.''')
