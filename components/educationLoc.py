...
# Filtrer les données pour un état spécifique (exemple : 'California')
state = "California"  # Remplacez par le nom de l'état souhaité
df_state = df[df['State'] == state]

# Calculer la moyenne de l'âge des mères par niveau d'éducation pour cet état
mean = df_state.groupby('Education Level of Mother')['Average Age of Mother (years)'].mean().sort_values()
